...
the probability for state 0 is 0.7, for state 1 the probability is 0.2 and 0.1 for state 2. Initially, all cells are in state 0 (resting). Clicking once sets them to
