...
The figures from the results section for this subtask can be recreated by running the Python file \texttt{phasePortrait.py} handed in with the report as a script.