...
As explained in the theory part, to create a phase portrait the map needs to be iterated over many time steps.
...
The figures from the results section for this task can be recreated by running the Python file \texttt{phasePortrait.py} handed in with the report as a script. They 
are saved in a folder named 'figures'.