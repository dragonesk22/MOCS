...
We decided to use 400 iterations and discard the first 150. We set these values at the beginning of our work and were satisfied with the results.
...
To obtain the bifurcation diagram (as in Figure \ref{fig:bifurcationcascade}) you need to run \verb+bifurcationCascade.py+. The figure will be displayed and saved 
in the folder `figures'. Thus, there must be a `figures' folder where you run the code. 
