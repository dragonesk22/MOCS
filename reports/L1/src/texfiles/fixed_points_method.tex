...
Newton's method comes to solve this problem. It is an iterative numerical procedure for solving nonlinear equations. In one dimension, it is used to solve equations of the form
\[
g(x)=0,
\]
which deeply resonates with the problem at hand.
