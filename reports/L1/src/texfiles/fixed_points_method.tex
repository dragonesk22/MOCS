...
The figures from the results section for this subtask can be recreated by running the Python file \texttt{periodicPoints.py} handed in with the report as a script.
